...
WebUI.setText(findTestObject('admin/Page_Data Kelas - PIJAR/input__namaKelas'), 'X-D')

WebUI.click(findTestObject('admin/Page_Data Kelas - PIJAR/button_Simpan'))

WebUI.verifyElementText(findTestObject('admin/Page_Data Kelas - PIJAR/h2_Sukses'), 'Sukses!')
