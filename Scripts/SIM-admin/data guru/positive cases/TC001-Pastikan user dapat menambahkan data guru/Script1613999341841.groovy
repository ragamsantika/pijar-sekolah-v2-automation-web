...
WebUI.clearText(findTestObject('admin/Page_Add Guru - PIJAR/input__tanggalLahir'))

WebUI.setText(findTestObject('admin/Page_Add Guru - PIJAR/input__tanggalLahir'), '16/02/1994')

WebUI.sendKeys(findTestObject('admin/Page_Add Guru - PIJAR/input__tanggalLahir'), Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('admin/Page_Add Guru - PIJAR/div_Pilih Gender'))
